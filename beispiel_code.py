...
# Funktion zur Begrüssung eines Benutzers mit Typehints
...
# Funktion zur Berechnung der Differenz zweier Zahlen mit Typehints
def berechne_differenz(zahl1: int, zahl2: int) -> int:
    """
    ...
    Returns:
      int: Die differenz zwischen den beiden Zahlen.
    """
    if zahl1 > zahl2:
      return zahl1 - zahl2
    elif zahl2 > zahl1:
...
diff_1 = berechne_differenz(6,2)
print("Die Differenz ist:", diff_1)

diff_2 = berechne_differenz(12.3, 8.78)
